...
int main()
{
    ...
    fprintf(stdout,
            "\n"
            COL_CYAN "      ___     " "%s"   COL_WHITE   "@"        COL_CYAN "%s\n"                        COL_RES /* user and host name */
            COL_CYAN "     (.· |    "        COL_WHITE_B "distro: " COL_CYAN "%s\n"                        COL_RES /* name of your linux distro */
            COL_CYAN "     (<> |    "        COL_WHITE_B "kernel: " COL_CYAN "%s\n"                        COL_RES /* kernel release */
            COL_CYAN "    / __  \\   "       COL_WHITE_B "uptime: " COL_CYAN "%lih %lim\n"                 COL_RES /* uptime */
            COL_CYAN "   ( /  \\ /|  "       COL_WHITE_B "ram:    " COL_CYAN "%lum / %lum / %lum / %lum\n" COL_RES /* ram info in Mb */
            COL_CYAN "  _/\ __)/_)   "       COL_WHITE_B "swap:   " COL_CYAN "%lum / %lum\n"               COL_RES /* swap info in Mb */
            COL_CYAN "  \\/-____\\/   "      COL_WHITE_B "procs:  " COL_CYAN "%d\n"                        COL_RES /* number of current processes */
            "\n",
