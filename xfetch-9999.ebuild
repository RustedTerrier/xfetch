...
LICENSE="GPL-2"
SLOT="0"
IUSE="disable-bold X xinerama +show-pkg-number"
...
src_compile() {
	...
	emake -j1 ID=gentoo bitfetch-build X="$(usex X YES NO)" XINERAMA="$(usex xinerama YES NO)" PKG="$(usex show-pkg-number YES NO)"
}
